                ...
                <div class="card d-flex flex-row mb-3">
                        <div class="d-flex flex-grow-1 min-width-zero">
                            <div class="card-body align-self-center  d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center" style="font-size: 1rem">
                                ...
                                <p class="mb-1 p-2" style="background-color: #273c75; color: #FFFFFF; border-radius: 50%">{{count($category->jobs)}}</p>
                                <div class="w-15" >
                                    <a href="{{route('category.edit', $category->id)}}" style="color: #8c7ae6" ><i class="bi bi-pencil-square"></i></a>
                                    <a href="{{route('category.delete', $category->id)}}" style="color: #c23616"><i class="bi bi-x-lg"></i></a>
                                </div>
                            </div>
                        </div>
                </div>
